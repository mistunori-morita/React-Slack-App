...
class Messages extends React.Component {
  ...
  addTypingListeners = channelId => {
    ...
    this.addToListeners(channelId, this.state.typingRef, "cihld_added");
    ...
    this.addToListeners(channelId, this.state.typingRef, "cihld_removed");
  ...
  addMessageListener = channelId => {
    ...
    this.addToListeners(channelId, ref, "cihld_added");
  };
